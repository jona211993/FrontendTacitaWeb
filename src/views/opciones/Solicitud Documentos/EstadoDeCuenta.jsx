...
const EstadoDeCuenta = () => {
  ...
  const onSubmitCorreo = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/registrarEECCTipoCorreo` ,
        {
          method: "POST",
          headers: {
  ...
  const onSubmitWhatsApp = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/registrarEECCTipoWsp`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const onSubmitOficina = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/registrarEECCTipoOficina`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const onSubmitCurier = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/registrarEECCTipoCourier`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="bg-cyan-900 w-3/4 rounded-xl p-3 flex flex-wrap gap-5 text-white animate__animated animate__fadeIn animate__faster ">
      <div className="flex justify-between w-full items-center ">
        <h1 className="text-xl pl-3 font-semibold">ESTADO DE CUENTA</h1>
